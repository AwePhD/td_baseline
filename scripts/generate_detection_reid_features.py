...
from tdbaseline.pstr_output import import_detection_output_from_hdf5, H5_FILE
...
def main():
    ...
    frame_file_to_detection = import_detection_output_from_hdf5(
        H5_FILE, FRAME_FOLDER)
