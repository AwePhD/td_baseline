...
def main():
    ...
    generate_captions_output_to_hdf5(annotations, model, Path.cwd() / 'outputs' / 'captions')
    ...
    assert_detection_output_and_annotations_compatibility(annotations, frame_file_to_detection)

    generate_frame_output_to_hdf5(frame_file_to_detection, model, Path.cwd() / 'outputs' / 'features')
