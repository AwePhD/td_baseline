...
def build_txt_preprocess(text_length: int, tokenizer: SimpleTokenizer) -> Callable[[str], torch.Tensor]:
    def txt_preprocess(caption: str):
        return tokenize(caption, tokenizer, text_length, truncate=True)
    return txt_preprocess
